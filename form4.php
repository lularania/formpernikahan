...
<html lang="en">
  <head>
    ...
    <title>Form Keterangan Tentang Orangtua | KUA Online Register</title>
  </head>
  <body>
    ...
    <div class="col-md-10">
      ...
      <h4 class="text-center font-weight-bold mr-6 mt-4 mb-4">Form Keterangan Tentang Orangtua</h4>
...
<div class="form-group font-weight-bold">
   <label>Dengan ini menyatakan bahwa</label>
 </div>
 <div class="form-group font-weight-bold">
...
<div class="form-group">
 ...
 <div class="form-group font-weight-bold">
   <label>Adalah benar ayah kandung dan ibu kandung dari</label>
 </div>
<div class="form-group">
  <label>Nama Lengkap dan Alias</label>
...
if (isset($_POST['save'])) 
{
     echo "<script>alert('Data Form Keterangan Tentang Orangtua Disimpan');</script>";
    echo "<meta http-equiv='refresh' content='1;url=form5.php'>";
